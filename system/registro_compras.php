<?php 
	...
	if(!empty($_POST)){
		...
		if(empty($_POST['idproveedor']) || empty($_POST['idarticulo']) || empty($_POST['tipo_comprobante']) || empty($_POST['serie_comprobante']) || empty($_POST['numero_comprobante']) || empty($_POST['existencia']) || empty($_POST['precio_compra'])){
			...
			// $query = "SELECT concat(registro_compras.serie_comprobante,'-', registro_compras.num_comprobante) AS serie_num_comprobante
			// 	FROM registro_compras AS registro_compras WHERE concat(registro_compras.serie_comprobante,'-', registro_compras.num_comprobante) = '$Serie_Num_Comprobante'";
			...
			// 	$query = "INSERT INTO registro_compras(idproveedor, idarticulo, tipo_comprobante, serie_comprobante, num_comprobante, existencia, precio_compra,idusuario)
			// 		VALUES('$idproveedor','$idarticulo','$tipo_comprobante','$serie_comprobante','$numero_comprobante','$existencia','$precio_compra','$idusuario')";

			// 	$query_insert = mysqli_query($con, $query);

			// 	if($query_insert){
			// 		$alert = '<p class="alert alert-success" role="alert">El Registro de la Compra Correctamente Ingresada. !!!</p>';
			// 	}else{
			// 		$alert = '<p class="alert alert-danger" role="alert">Error Al Registrar la Compra. !!!</p>';
			// 	}
...
<html lang="en">
	<head>
		...
		<title>Registro-Compras|| Sistema-Accesorios D-ASTU</title>
	...
	<body>
		...
		<section id="container">
			...
			<div class="form_register">
				<h3><i class="fas fa-user-tie"></i> Registro Compras</h3>
				<hr>
